...
RSpec.describe BundledProduct, type: :model do
  ...
  describe "validations" do
    ...
    let(:bundle) { Product.create!(name: "Bundle Product", brand: "Test", is_bundle: true, price: 10, created_by_user: user) }
    let(:component) { Product.create!(name: "Component Product", brand: 'Test', is_bundle: false, price: 5, created_by_user: user) }
    ...
    it "is invalid if bundle is not a bundle product" do
      not_a_bundle = Product.create!(name: "Not a Bundle", brand: 'Test', is_bundle: false, price: 5, created_by_user: user)
    ...
    it "is invalid if component is a bundle product" do
      component = Product.create!(name: "Component Bundle", brand: 'Test', is_bundle: true, price: 15, created_by_user: user)
      bundled_product = BundledProduct.new(bundle: bundle, component: component, quantity: 2)
      expect(bundled_product).not_to be_valid
    end
  end
